...
void PreRender_MotionBlurImpl(PreRenderContext* this, Gfx** gfxp, void* buf, void* bufSave, s32 envR, s32 envG, s32 envB, s32 envA) {
    Gfx* gfx = *gfxp;
    uObjBg* bg;
    ...
    // Load S2DEX
    gSPLoadUcodeEx(gfx++, OS_K0_TO_PHYSICAL(D_80113070), OS_K0_TO_PHYSICAL(D_801579A0), 0x800);
    gDPPipeSync(gfx++);
